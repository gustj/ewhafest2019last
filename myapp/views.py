...
def show_comment(request, board_id, comment_id):
    comments = Comment.objects.get(pk = board_id)
    comment1 = comments.objects.aggregate(id = Max('id'))
    
    return render(request, 'search_result.html',{'comment1':comment1})